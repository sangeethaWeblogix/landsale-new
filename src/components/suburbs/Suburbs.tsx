...
export default function LandPage({
  ...
  const townhouseLand = data?.townhouse_listings ?? [];
  return (
    <>
      {/* Top Section */}
              ...
              <div className="row">
                <div className="col-lg-9">
                  <div className="row">
                      ...
                      <div className="row">
                        <div className="col-lg-12">
                          <h3 className="title text-start">
                            Land Listings in {suburbName}{" "}
                            {state.toLocaleUpperCase()}
                          </h3>
                        </div>
                        {/* Card 1 */}
                        <div className="row">
                          {landListings.map((item: any, index:number) => (
                            <div className="col-lg-4" key={index}>
                              <a
                                href={`/land/${item.estate_slug}`}
                    ...
                    {houseAndLandListings.length > 0 && (
                      <div className="row">
                        <div className="col-lg-12">
                          <h3 className="title text-start">
                            House and Land Listings in {suburbName}{" "}
                            {state.toLocaleUpperCase()}
                          </h3>
                        </div>
                        ...
                        {/* Card 1 */}
                         <div className="row">
                          {houseAndLandListings.map((item: any, index:number) => (
                            <div className="col-lg-4" key={index}>
                          <a href="#" className="homelengo-categories">
                            <div className="listing-card">
                              ...
                              <div className="info_content">
                                ...
                                <p className="location">
                                  <i className="icon icon-mapPin"></i> Ashfield,
                                  VIC
                                </p>
                    ...
                    {townhouseLand.length > 0 && (
                      <div className="row">
                        <div className="col-lg-12">
                          <h3 className="title text-start">
                            Townhouse Listings in {suburbName}{" "}
                            {state.toLocaleUpperCase()}
                          </h3>
                        </div>
                        ...
                        {/* Card 1 */}
                      <div className="row">
                          {townhouseLand.map((item: any, index:number) => (
                            <div className="col-lg-4" key={index}>
                          <a href="#" className="homelengo-categories">
                            <div className="listing-card">
                              <div className="image_card">
                                <img
                                  src="https://www.landsales.com.au/wp-content/uploads/2025/11/3608-nagambie-goulburn-valley-victoria.jpg"
                                  alt=""
                                />
                              </div>
                              <div className="info_content">
      ...
      {nearbyLand.length > 0 && (
        <section className="flat-section slider_new flat-categories-1 arrow_shadow bg_color_2">
          <div className="container">
            <div className="box-title style-1 wow fadeInUp">
              <h3 className="title">Browse Land for Sale Near {suburbName}</h3>

             <div className="row">
                          {nearbyLand.map((item: any, index: number) => (
